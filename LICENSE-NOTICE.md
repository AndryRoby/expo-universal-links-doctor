...
- Use the hosted tool at https://arling.sk/expo-universal-links-doctor/
  freely, for any purpose, personal or commercial, at no cost.
- Read the source of `index.html` / `doctor-universal-links.js` to understand or
...
- Use the "Expo Universal Links & App Links Doctor" name, the
  ARLing s. r. o. name, or associated branding for your own project.
